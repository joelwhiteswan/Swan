    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    horseNames = _a.sent();
                    return [4 /*yield*/, page.$$eval("span.ui-runner-price", function (prices) {
                            return prices.map(function (price) { return price.textContent || ""; });
                        })];
                case 6:
                    horseOdds = _a.sent();
                ...
                case 7:
                    _a.sent();
                    return [2 /*return*/, JSON.stringify(mergedData)];
            }
        });
    });
}
...
scrapeHorseRacingOdds(url).then(function (data) { return console.log(data); });
