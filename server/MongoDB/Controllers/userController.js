...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, rest, user, hashedPassword, newUser, savedUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, password = _a.password, rest = __rest(_a, ["email", "password"]);
                _b.label = 1;
            case 1:
                _b.trys.push([1, 5, , 6]);
            ...
            case 3:
                ...
                newUser = new userSchema_1.default(__assign({ email: email, password: hashedPassword }, rest));
            ...
            case 5:
                error_1 = _b.sent();
                console.log(error_1);
                res.status(400).send({ error: error_1 + "Could not create user" });
                return [3 /*break*/, 6];
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                error_2 = _b.sent();
                res.status(401).send({ error: error_2, message: "Email and/or password incorrect" });
                return [3 /*break*/, 5];
